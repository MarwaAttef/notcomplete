package com.example.marwa.pagination_retrofit_database.adapter;
...
public class PaginationAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    //-----------------------------------Pagination Adapter------------------------------------------//
    public PaginationAdapter(Context context,PaginationAdapterCallback callbk ) {
        this.context = context;
        this.mCallback = callbk;
